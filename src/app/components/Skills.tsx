...
export const Skills = () => {
	return (
		<div className="flex flex-1 w-full items-center min-h-[6rem] dark:bg-dot-white/[0.2] bg-dot-black/[0.2] flex-row space-x-2">
			<motion.div
			...
			>
				...
				<p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">Node.js</p>
			</motion.div>
			<motion.div
			...
			>
				...
				<p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">React</p>
			</motion.div>
			<motion.div
			...
			>
				...
				<p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">JavaScript</p>
			</motion.div>
			<motion.div
				variants={{ initial: { x: -50, rotate: 5 }, hover: { x: 0, rotate: 0 } }}
				className="origin-center z-10 h-full w-1/5 rounded-2xl bg-white p-4 dark:bg-black dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center"
			>
				...
				<p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">TypeScript</p>
			</motion.div>
			<motion.div
				variants={{ initial: { x: -100, y: 5, rotate: 10 }, hover: { x: 0, y: 0, rotate: 0 } }}
			...
			>
				...
				<p className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">Next.js</p>
			</motion.div>
		</div>
	);
};
